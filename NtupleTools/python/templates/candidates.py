...
base_jet = PSet(
    ...
    objectJetptD  =  '(evt.jetVariables({object_idx}, "ptD")) : -100',
    objectJetaxis1  =   '? {object}.userCand("patJet").isNonnull ? '
    'evt.jetVariables({object_idx},"axis1") : -100 ',
    objectJetaxis2  =   '? {object}.userCand("patJet").isNonnull ? '
    '(evt.jetVariables({object_idx},"axis2")) : -100',
    objectJetmult  =   '? {object}.userCand("patJet").isNonnull ? '
    '(evt.jetVariables({object_idx},"mult")) : -100',
    objectJetmultMLPQC  =   '? {object}.userCand("patJet").isNonnull ? '
    '(evt.jetVariables({object_idx},"mult_MLP_QC")) : -100 ',
