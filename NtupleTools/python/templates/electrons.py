...
trigger = PSet(
    ...
    objectMatchesSingleE    = r'matchToHLTPath({object_idx}, "HLT_Ele27_eta2p1_WP85\\d+,HLT_Ele20WP60_Ele8_Mass55_v1\\d+,HLT_Ele25WP60_SC4_Mass55_v1\\d+")',
    objectMatchesSingleEPlusMET = r'matchToHLTPath({object_idx},"HLT_Ele27_WP80_PFMET_MT50_v\\d+,HLT_Ele32_WP70_PFMT50_v\\d+")',    
    objectMatchesSingleE27etaWP85 = r'matchToHLTPath({object_idx}, "HLT_Ele27_eta2p1_WP85\\d+")',
    objectMatchesSingleE20WP60Mass55 = r'matchToHLTPath({object_idx},"HLT_Ele20WP60_Ele8_Mass55_v1\\d+")',
    objectMatchesSingleE25WP60Mass55 = r'matchToHLTPath({object_idx},"HLT_Ele25WP60_SC4_Mass55_v1\\d+")',
)
