...
met = PSet(
    ...
    pfMet_ees_plus_Et   = 'evt.met4vector("pfmet","ees+", 1).Et',
    pfMet_mes_plus_Et   = 'evt.met4vector("pfmet","mes+", 1).Et',
    pfMet_tes_plus_Et   = 'evt.met4vector("pfmet","tes+", 1).Et',
    pfMet_ues_plus_Et   = 'evt.met4vector("pfmet","ues+", 1).Et',
    pfMet_ees_minus_Et   = 'evt.met4vector("pfmet","ees-", 1).Et',
    pfMet_mes_minus_Et   = 'evt.met4vector("pfmet","mes-", 1).Et',
    pfMet_tes_minus_Et   = 'evt.met4vector("pfmet","tes-", 1).Et',
    pfMet_ues_minus_Et   = 'evt.met4vector("pfmet","ues-", 1).Et',
    ...
    pfMet_ees_plus_Phi  = 'evt.met4vector("pfmet","ees+", 1).phi',
    pfMet_mes_plus_Phi  = 'evt.met4vector("pfmet","mes+", 1).phi',
    pfMet_tes_plus_Phi  = 'evt.met4vector("pfmet","tes+", 1).phi',
    pfMet_ues_plus_Phi  = 'evt.met4vector("pfmet","ues+", 1).phi',
    pfMet_ees_minus_Phi  = 'evt.met4vector("pfmet","ees-", 1).phi',
    pfMet_mes_minus_Phi  = 'evt.met4vector("pfmet","mes-", 1).phi',
    pfMet_tes_minus_Phi  = 'evt.met4vector("pfmet","tes-", 1).phi',
    pfMet_ues_minus_Phi  = 'evt.met4vector("pfmet","ues-", 1).phi',
