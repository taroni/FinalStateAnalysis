...
datadefs = {
      'ggHBB' : {
            'analyses': ['ET'],
            'datasetpath' : "/GluGluToHToBB_M-125_8TeV-powheg-pythia6/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM",
            'x_sec': xsbr(8,125,'ggf','bb')[0],
            'pu': 'S10',
            'calibrationTarget': 'Moriond2013',
      },
      'vbfHBB' : {
            'analyses': ['ET'],
            'datasetpath' : "/VBF_HToBB_M-125_8TeV-powheg-pythia6/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM",
            'x_sec':  xsbr(8,125,'vbf','bb')[0],
            'pu': 'S10',
            'calibrationTarget': 'Moriond2013',
      },
      'ggHWW' : {
      ...
      'WH_ZH_TTH_HToTauTau' : {
            ...
            'x_sec': xsbr(8,125,'tth','tautau')[0]+ xsbr(8,125,'wh','tautau')[0]+ xsbr(8,125,'zh','tautau')[0],
            'pu': 'S10',
            'calibrationTarget': 'Moriond2013',
      },
      'WH_ZH_TTH_HToWW' : {
             'analyses': ['ET'],
            'datasetpath' : "/WH_ZH_TTH_HToWW_M-125_8TeV-pythia6-tauola/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM/",
            'x_sec':  xsbr(8,125,'tth','WW')[0]+ xsbr(8,125,'wh','WW')[0]+ xsbr(8,125,'zh','WW')[0],
            'pu': 'S10',
            'calibrationTarget': 'Moriond2013',
     },
      'WWJets' : {
      ...
      'WplusJets_madgraph' : {
            'analyses': ['HTT'],
            'datasetpath': '/WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball/Summer12_DR53X-PU_S10_START53_V7A-v2/AODSIM',#'/WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball/Summer12-PU_S7_START52_V9-v1/AODSIM',
            'pu': 'S10',# 'S7',
            'calibrationTarget': 'Summer12',
            'x_sec': 36257.2,
      },
      ...
      'Wplus1Jets_madgraph' : {
            'analyses': ['HTT'],
            'datasetpath': '/W1JetsToLNu_TuneZ2Star_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V19-v1/AODSIM',#'/W1JetsToLNu_TuneZ2Star_8TeV-madgraph-tarball/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM',
            'pu': 'S10',
            'calibrationTarget': 'Summer12',
            'x_sec': 6381,
      },
      ...
      'Wplus2Jets_madgraph' : {
            'analyses': ['HTT'],
            'datasetpath': '/W2JetsToLNu_TuneZ2Star_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM',#'/W2JetsToLNu_TuneZ2Star_8TeV-madgraph-tarball/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM',
            'pu': 'S10',#'S7',
            'calibrationTarget': 'Summer12',
            'x_sec': 2030,
      },
      ...
      'TTJets_DD' : {
            'analyses': ["ET"],
            'datasetpath' : "/TTJets_DileptDecays_8TeV-sherpa/Summer12_DR53X-PU_S10_START53_V19-v1/AODSIM",
            'x_sec' : 26.1975,
            'pu' : 'S10',
            'calibrationTarget' : 'Summer12_DR53X',
      },
...
datadefs['ZetauEmbedded_Run2012D_noEmbeddedPat']=  {
      'analyses': ['ET'],
      'datasetpath' : "/DoubleMuParked/StoreResults-Run2012D_22Jan2013_v1_RHembedded_trans1_tau115_ptelec1_20had1_18_v1-f456bdbb960236e5c696adfe9b04eaae/USER",
      'lumi_mask' : "FinalStateAnalysis/RecoTools/data/masks/Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt",
      'calibrationTarget':'Moriond2013'
...
data_DoubleE, list_DoubleE = build_data_set('DoubleElectron', ['VH','4L','HZG','ET'])
